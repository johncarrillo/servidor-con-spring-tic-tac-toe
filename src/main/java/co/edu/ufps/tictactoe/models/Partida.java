...
public class Partida {
    ...
    public Partida() {
        ...
        this.estadoPartida = new EstadoPartida(this);
    }
    ...
    public boolean agregarMovimiento (String movimiento, char marca) {
    	...
    	movimiento = movimiento.substring(0,3);
    ...
    public boolean agregarMovimiento (int x, int y, char marca) {
        ...
        if (this.siguienteJugador != null) {
            resultadoPartida = this.tablero.agregarMovimiento(x, y, this.siguienteJugador.getMarca());
        } else {
            resultadoPartida = this.tablero.agregarMovimiento(x, y, marca);
        }
        if (resultadoPartida == 1) {
            ...
            this.usuario1.setPuntaje(
                    this.siguienteJugador.getPuntaje() + 3);
            this.usuario2.setPuntaje(
                    this.siguienteJugador.getPuntaje() + 3);
            this.informarEmpate();
        }
        /*
    ...
    public String toString () {
        if (this.usuario1 != null) {
            System.out.println("Usuario1 {nombre =" + this.usuario1.getNombre() + "}");
        }
        if (this.usuario2 != null) {
            System.out.println("Usuario1 {nombre =" + this.usuario2.getNombre() + "}");
        }
        return "";
    }
    ...
    public EstadoPartida getEstadoPartida(boolean movimientoValido, Usuario usuario) {
        estadoPartida.agregarParametros(movimientoValido, usuario);
    ...
    public boolean validarAmbosJugadores () {
        if (this.usuario1 == null || this.usuario2 == null) {
            return false;
        }
        return true;
    }
